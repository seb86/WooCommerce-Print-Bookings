...
if ( ! class_exists( 'WC_Print_Bookings_Admin' ) ) {
	class WC_Print_Bookings_Admin {
		...
		public function styles_and_scripts() {
			...
			wp_register_script( 'wc_print_bookings_js', WC_Print_Bookings::plugin_url() . '/assets/js/wc-print-bookings' . $suffix . '.js', array( 'jquery', 'jquery-ui-datepicker' ), WC_Print_Bookings::$version, true );
